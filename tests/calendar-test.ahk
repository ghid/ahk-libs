...
class CalendarTest extends TestCase {
	...
	@Test_helperClass() {
		...
		this.assertTrue(IsFunc(Calendar.Helper.validTime))
	}

	@Test_testForValidYear() {
		this.assertEquals(Calendar.Helper.testForValidYear(A_Now), A_Now)
		this.assertException(Calendar.Helper, "testForValidYear",,, 1600)
	}

	@Test_testForValidMonth() {
		this.assertEquals(Calendar.Helper.testForValidMonth(A_Now), A_Now)
		this.assertEquals(Calendar.Helper.testForValidMonth(2019), 201901)
		this.assertException(Calendar.Helper, "testForValidMonth",,, 201900)
		this.assertException(Calendar.Helper, "testForValidMonth",,, 201913)
	}

	@Test_testForValidDay() {
		this.assertEquals(Calendar.Helper.testForValidDay(A_Now), A_Now)
		this.assertEquals(Calendar.Helper.testForValidDay(20190812), 20190812)
		this.assertEquals(Calendar.Helper.testForValidDay(201908), 20190801)
		this.assertException(Calendar.Helper, "testForValidDay",,, 20190800)
		this.assertException(Calendar.Helper, "testForValidDay",,, 20190631)
		this.assertException(Calendar.Helper, "testForValidDay",,, 20191232)
		this.assertException(Calendar.Helper, "testForValidDay",,, 20190229)
	}

	@Test_testForValidHour() {
		this.assertEquals(Calendar.Helper.testForValidHour(A_Now), A_Now)
		this.assertEquals(Calendar.Helper.testForValidHour(2019081208)
				, 2019081208)
		this.assertEquals(Calendar.Helper.testForValidHour(2019081200)
				, 2019081200)
		this.assertEquals(Calendar.Helper.testForValidHour(2019081223)
				, 2019081223)
		this.assertException(Calendar.Helper, "testForValidHour",,, 2019081224)
	}

	@Test_testForValidMinutes() {
		this.assertEquals(Calendar.Helper.testForValidMinutes(A_Now), A_Now)
		this.assertEquals(Calendar.Helper.testForValidMinutes(201908120848)
				, 201908120848)
		this.assertEquals(Calendar.Helper.testForValidMinutes(201908120859)
				, 201908120859)
		this.assertEquals(Calendar.Helper.testForValidMinutes(2019081208)
				, 201908120800)
		this.assertException(Calendar.Helper, "testForValidMinutes"
				,,, 201908120860)
	}

	@Test_testForValidSeconds() {
		this.assertEquals(Calendar.Helper.testForValidSeconds(A_Now), A_Now)
		this.assertEquals(Calendar.Helper.testForValidSeconds(20190812084836)
				, 20190812084836)
		this.assertEquals(Calendar.Helper.testForValidSeconds(20190812085900)
				, 20190812085900)
		this.assertEquals(Calendar.Helper.testForValidSeconds(20190812085959)
				, 20190812085959)
		this.assertEquals(Calendar.Helper.testForValidSeconds(201908120859)
				, 20190812085900)
		this.assertException(Calendar.Helper, "testForValidSeconds"
				,,, 20190812085160)
	}

	@Test_returnMaxDaysForFebruary() {
		this.assertEquals(Calendar.Helper.returnMaxDaysForFebruary(2019), 28)
		this.assertEquals(Calendar.Helper.returnMaxDaysForFebruary(2020), 29)
		this.assertEquals(Calendar.Helper.returnMaxDaysForFebruary(2100), 28)
	}

	@Test_CalendarHelper_daysInMonth() {
		this.assertEquals(Calendar.Helper.daysInMonth(201901, 01), 31)
		this.assertEquals(Calendar.Helper.daysInMonth(201902, 02), 28)
		this.assertEquals(Calendar.Helper.daysInMonth(201903, 03), 31)
		this.assertEquals(Calendar.Helper.daysInMonth(201904, 04), 30)
		this.assertEquals(Calendar.Helper.daysInMonth(201905, 05), 31)
		this.assertEquals(Calendar.Helper.daysInMonth(201906, 06), 30)
		this.assertEquals(Calendar.Helper.daysInMonth(201907, 07), 31)
		this.assertEquals(Calendar.Helper.daysInMonth(201908, 08), 31)
		this.assertEquals(Calendar.Helper.daysInMonth(201909, 09), 30)
		this.assertEquals(Calendar.Helper.daysInMonth(201910, 10), 31)
		this.assertEquals(Calendar.Helper.daysInMonth(201911, 11), 30)
		this.assertEquals(Calendar.Helper.daysInMonth(201912, 12), 31)
		this.assertEquals(Calendar.Helper.daysInMonth(202002, 02), 29)
		this.assertEquals(Calendar.Helper.daysInMonth(210002, 02), 28)
	}

	@Test_testForValidInteger() {
		this.assertTrue(Calendar.Helper.testForValidInteger(0))
		this.assertTrue(Calendar.Helper.testForValidInteger(123))
		this.assertTrue(Calendar.Helper.testForValidInteger(-123))
		this.assertException(Calendar.Helper, "testForValidInteger",,, "abc")
	}

	@Test_testForValidNumber() {
		this.assertTrue(Calendar.Helper.testForValidNumber(0))
		this.assertTrue(Calendar.Helper.testForValidNumber(123))
		this.assertTrue(Calendar.Helper.testForValidNumber(-123))
		this.assertTrue(Calendar.Helper.testForValidNumber(123.))
		this.assertTrue(Calendar.Helper.testForValidNumber(-123.))
		this.assertTrue(Calendar.Helper.testForValidNumber(123.0))
		this.assertTrue(Calendar.Helper.testForValidNumber(123.9))
		this.assertTrue(Calendar.Helper.testForValidNumber(123.456))
		this.assertTrue(Calendar.Helper.testForValidNumber(-123.456))
		this.assertTrue(Calendar.Helper.testForValidNumber(.456))
		this.assertTrue(Calendar.Helper.testForValidNumber(-.456))
		this.assertTrue(Calendar.Helper.testForValidNumber(-0.456))
		this.assertTrue(Calendar.Helper.testForValidNumber(+123.456))
		this.assertTrue(Calendar.Helper.testForValidNumber(-.0))
		this.assertTrue(Calendar.Helper.testForValidNumber(-0.))
		this.assertException(Calendar.Helper, "testForValidNumber",,, "abc")
		this.assertException(Calendar.Helper, "testForValidNumber",,, "-1,5")
	}

	@Test_testForValidWeekDay() {
		loop 7 {
			this.assertTrue(Calendar.Helper.testForValidWeekDay(A_Index))
		}
		this.assertException(Calendar.Helper, "testForValidWeekDay",,, 0)
		this.assertException(Calendar.Helper, "testForValidWeekDay",,, 8)
	}

	@Test_adjustMonthAndHandleUnderFlowOrOverFlow() {
		ts := new Calendar("20190121")
		Calendar.Helper.adjustMonthAndHandleUnderFlowOrOverFlow(ts, -1)
		this.assertEquals(ts.asDate(), "20181221")
		Calendar.Helper.adjustMonthAndHandleUnderFlowOrOverFlow(ts, 1)
		this.assertEquals(ts.asDate(), "20190121")
		Calendar.Helper.adjustMonthAndHandleUnderFlowOrOverFlow(ts, 1)
		this.assertEquals(ts.asDate(), "20190221")
		Calendar.Helper.adjustMonthAndHandleUnderFlowOrOverFlow(ts, 6)
		this.assertEquals(ts.asDate(), "20190821")
		Calendar.Helper.adjustMonthAndHandleUnderFlowOrOverFlow(ts, 10)
		this.assertEquals(ts.asDate(), "20200621")
	}

	@Test_findNextOrFirstOccurenceOfWeekDay() {
		this.assertTrue(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(0))
		this.assertTrue(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(0.1))
		this.assertTrue(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(0.5))
		this.assertTrue(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(1))
		this.assertTrue(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(3))
		this.assertFalse(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(-.1))
		this.assertFalse(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(-.9))
		this.assertFalse(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(-1))
		this.assertFalse(Calendar.Helper.findNextOrFirstOccurenceOfWeekDay(-3))
	}
	...
	@Test_daysInMonth() {
		...
		this.assertException(Calendar.Helper, "daysInMonth",,, "abc")
	}
